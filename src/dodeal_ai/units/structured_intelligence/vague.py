...
def allowed_components_check(
    ...
    OutputValidationError like any other malformed answer and earns Phase G's
    single reprompt.
...
async def detect_vagueness(
    ...
    *,
    ...
    """One model call against this type's template. Returns the validated answer
    and the raw response, whose `model` the judgement is stamped with."""
